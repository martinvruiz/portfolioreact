...
const notebook = '/images/proyects/Notebook.png'
const financer = '/images/proyects/Financer.png'

const images = [tasktodo, riverplate, logo, passcheck, notebook, financer]
